...
class TravelTasks:
    ...
    def plan_itinerary(self, agent, city, travel_dates, interests):
        ...
        """
            ...
            expected_output = "Give the pefect plan for travelling",
            agent=agent,
        )
    ...
    def identify_city(self, agent, origin, cities, interests, travel_dates):
        ...
        """
            ...
            expected_output = "Give breif information about that city",
            agent=agent,
        )
    ...
    def gather_city_info(self, agent, city, travel_dates, interests):
        ...
        """
            ...
            expected_output = "Tell about the local good things",
            agent=agent,
        )
